...
module.exports = {
  ...
  "menu.conections": "Conexões",
  "menu.administration": "Administração",
  "menu.cfg": "Configurações",
  "menu.settings": "Configurações",
  "menu.users": "Usuários",
  "menu.profiles": "Perfil de acesso",
  "menu.operations": "Operações dos módulos",
  ...
  submit: "Salvar",
  action: "Ação",
  "users.another-action": "Another action",
  "display-options": "Mostrar opções",
  orderby: "Ordernar por : ",
  "all-items": "Todos os registros",
  "inactive-items": "Registros inativos",
  "active-items": "Registros ativos",
