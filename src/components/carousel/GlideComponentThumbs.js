...
function GlideComponentThumbs(props = defaultProps) {
  ...
  const [thumbsPerView, setThumbsPerView] = useState(Math.min(props.settingsThumbs.perView, props.settingsImages.data.length));
  ...
  const thumbsResize = () => {
    const perView = Math.min(props.settingsThumbs.perView, props.settingsImages.data.length);
              ...
              return (
                <div key={item.id}>
                  <div className="glide__slide">
                    <img alt="detail" src={item.img} className="responsive border-0 border-radius img-fluid mb-3" />
                  </div>
                </div>
              );
            })}
            ...
            {props.settingsThumbs.data.map((item, index) => {
              return (
                <div
                  ...
                  <img alt="detail" src={item.img} className="responsive border-0 border-radius img-fluid" />
                </div>
              );
            })}
          </div>
